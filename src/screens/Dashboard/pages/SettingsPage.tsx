    ...
    <ProtectedRoute>
      <DashboardLayout>
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <Card className="bg-[#1e282d] border-[#3d4f5b]" id="profile-information">
          ...
          <Card className="bg-[#1e282d] border-[#3d4f5b]" id="plan-billing">
            <CardContent className="p-6">
              ...
              <div className="mb-8">
                <h4 className="[font-family:'Lexend',Helvetica] font-bold text-white text-base mb-4">
                  Current Subscription
                </h4>
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-4 bg-[#0f1419] rounded-lg">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h5 className="[font-family:'Lexend',Helvetica] font-bold text-white text-xl">
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 bg-[#0f1419] rounded-lg">
                    <h5 className="[font-family:'Lexend',Helvetica] font-medium text-white text-sm mb-2">
                      Payment Method
                    </h5>
                    <p className="[font-family:'Lexend',Helvetica] text-[#9eafbf] text-sm">
          ...
          <Card className="bg-[#1e282d] border-[#3d4f5b]" id="notifications">
            <CardContent className="p-6">
              <h3 className="[font-family:'Lexend',Helvetica] font-bold text-white text-lg mb-6">
          ...
          {/* Account Actions */}
          <Card className="bg-[#1e282d] border-[#3d4f5b]" id="account-actions">
            <CardContent className="p-6">
              <h3 className="[font-family:'Lexend',Helvetica] font-bold text-white text-lg mb-6">
                Account Actions
              </h3>
