...
export const FeaturesGridSection = (): JSX.Element => {
  return (
    <section className="flex items-start justify-center px-4 md:px-10 lg:px-40 py-10 w-full theme-bg-primary">
      <div className="flex flex-col max-w-[1200px] w-full">
          ...
          {features.map((feature, index) => (
            <Card 
              ...
              className={`${
                ...
                feature.highlight ? 'hover:shadow-[#3f8cbf]/20' : 'hover:shadow-black/10 dark:hover:shadow-white/10'
              }`}
            >
              <CardContent className="p-6 flex flex-col gap-4 h-full">
                ...
                <div className="flex flex-col gap-3 flex-1">
                  <h3 className={`[font-family:'Lexend',Helvetica] font-bold text-lg tracking-[0] leading-6 ${
                    feature.highlight ? 'text-white' : 'theme-text-primary'
                  }`}>
                    {feature.title}
                  </h3>
                  <p className={`[font-family:'Lexend',Helvetica] font-normal text-sm tracking-[0] leading-[21px] ${
                    feature.highlight ? 'text-white/90' : 'theme-text-muted'
                  }`}>
                    {feature.description}
                  </p>
                </div>
        ...
        <div className="mt-20 flex flex-col items-center gap-10">
          <div className="text-center">
            ...
            <p className="[font-family:'Lexend',Helvetica] font-normal theme-text-secondary text-base tracking-[0] leading-6 max-w-[600px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-[800px]">
            <div className="flex flex-col items-center text-center gap-4 p-6 theme-bg-secondary rounded-xl theme-border border">
              <div className="text-4xl font-black text-[#3f8cbf] [font-family:'Lexend',Helvetica]">
                95%
              </div>
              <h3 className="theme-text-primary font-bold text-lg [font-family:'Lexend',Helvetica]">
                Success Rate
              </h3>
              <p className="theme-text-muted text-sm [font-family:'Lexend',Helvetica]">
