      ...
      <section className="flex items-start justify-center px-4 md:px-6 lg:px-10 xl:px-40 py-12 md:py-20 w-full bg-[#0f1419]">
        <div className="flex flex-col max-w-[1200px] w-full">
          ...
          <div className="text-center mb-12 md:mb-16">
            <h1 className="[font-family:'Lexend',Helvetica] font-black text-white text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl tracking-[-2.00px] leading-[1.1] mb-4 md:mb-6">
              Get in Touch
            </h1>
            <p className="[font-family:'Lexend',Helvetica] font-normal text-[#9eafbf] text-base md:text-lg tracking-[0] leading-6 md:leading-7 max-w-[600px] mx-auto">
              ...
              <Card key={index} className="bg-[#1e282d] border-[#3d4f5b] hover:scale-105 transition-all duration-300 hover:shadow-lg hover:shadow-white/10">
                <CardContent className="p-4 md:p-6 flex flex-col gap-3 md:gap-4 text-center">
                  ...
                  <div className="flex flex-col gap-1 md:gap-2">
                    <h3 className="[font-family:'Lexend',Helvetica] font-bold text-white text-base md:text-lg tracking-[0] leading-6">
                      {info.title}
                    </h3>
                    <p className="[font-family:'Lexend',Helvetica] font-normal text-[#9eafbf] text-xs md:text-sm tracking-[0] leading-5">
                      {info.description}
                    </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start">
            ...
            <Card className="bg-[#1e282d] border-[#3d4f5b] order-1 lg:order-2">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4 md:gap-6">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <textarea
                      ...
                      required
                      rows={4}
                      className="w-full px-3 md:px-4 py-2 md:py-3 bg-[#0f1419] border border-[#3d4f5b] rounded-lg text-white placeholder-[#9eafbf] focus:border-[#3f8cbf] focus:outline-none transition-colors resize-none [font-family:'Lexend',Helvetica] text-sm md:text-base"
